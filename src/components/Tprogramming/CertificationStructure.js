  ...
  return (
    <div className="cert-practice">
      <div className="cert-item">
        ...
        <div className="box">
          <p>
            Pas përfundimit me sukses të programit 6-mujor për Programim, çdo
            pjesëmarrës pajiset me 6 certifikata, një për secilin modul të
            përfunduar. Certifikatat janë të njohura në tregun vendor dhe
            shërbejnë si dëshmi e aftësive të fituara gjatë trajnimit. Ato janë
            të vlefshme për punësim, aplikim në projekte, bashkëpunime me
